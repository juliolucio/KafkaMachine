...
//--------------------------------------------------------------
void KafkaMachineArduinoHardware::setup(){
	...
	ard.connect("/dev/cu.usbserial-A4001qyq", 57600);
	
	// listen for EInitialized notification. this indicates that
	// the arduino is ready to receive commands and it is safe to
	// call setupArduino()
	ofAddListener(ard.EInitialized, this, &KafkaMachineArduinoHardware::setupArduino);
...
void KafkaMachineArduinoHardware::setupArduino(const int & version) {
	...
	ofRemoveListener(ard.EInitialized, this, &KafkaMachineArduinoHardware::setupArduino);
    ...
    ofAddListener(ard.EDigitalPinChanged, this, &KafkaMachineArduinoHardware::digitalPinChanged);
    ofAddListener(ard.EAnalogPinChanged, this, &KafkaMachineArduinoHardware::analogPinChanged);    
}
